...
Generado el 2026-09-26T17:47:48 con el modelo de embeddings `sentence-transformers/paraphrase-multilingual-mpnet-base-v2` y pooling `media` para los modelos principales.
...
|---|---|---|---|---|---|---|
| **Modelo de reglas (opciones 7 y 8), validación cruzada (5 particiones, promedio de 10 repeticiones)** | 0.651 | 0.934 | 0.260 | 0.601 | 0.768 | 0.384 |
...
| criterio | MAE | R² |
|---|---|---|
| gt_afinidad_resistencia_femenina | 1.323 | 0.288 |
| gt_afinidad_contemplación_inmersiva | 1.294 | 0.443 |
| gt_afinidad_ternura_y_empatía_radical | 1.277 | 0.367 |
| gt_afinidad_humanismo_social | 0.977 | 0.455 |
| gt_afinidad_vanguardia_y_simbolismo | 0.992 | 0.569 |
| gt_cols_camaradería_masculina_rancia | 0.516 | -0.029 |
| gt_cols_insoportabilidad_prolongada | 1.951 | 0.248 |
| gt_cols_control_emocional_artificial | 1.542 | 0.358 |
| gt_cols_personajes_diorama | 1.625 | 0.162 |
| gt_cols_caos_asfixiante | 1.449 | 0.235 |
| gt_excepcion_camaradería_masculina_rancia | 0.232 | 0.018 |
| gt_excepcion_insoportabilidad_prolongada | 0.394 | 0.074 |
| gt_excepcion_personajes_diorama | 0.020 | -0.026 |
| gt_excepcion_caos_asfixiante | 0.112 | -0.008 |
...
|---|---|---|---|
| amelie | 4.50 | 8.50 | 4.00 |
| manhattan | 5.00 | 8.01 | 3.01 |
| la-la-land | 5.50 | 8.20 | 2.70 |
| primer | 6.50 | 8.74 | 2.24 |
| the-royal-tenenbaums | 6.80 | 8.53 | 1.73 |
| barry-lyndon | 6.50 | 8.19 | 1.69 |
| crouching-tiger-hidden-dragon | 9.50 | 7.85 | -1.65 |
| rocky | 9.20 | 7.63 | -1.57 |
| marty-supreme | 5.50 | 6.90 | 1.40 |
| anne-of-green-gables | 9.80 | 8.62 | -1.18 |
