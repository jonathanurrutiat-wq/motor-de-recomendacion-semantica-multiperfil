...
Generado el 2026-09-26T14:14:04 con el modelo de embeddings `sentence-transformers/paraphrase-multilingual-mpnet-base-v2`.
...
|---|---|---|---|---|---|---|---|
| percentil 75 por dimensión, todas las reseñas | 768 | 0.595 | 0.376 | 0.406 | 0.130 | -0.007 | 0.005 |
| promedio + percentiles de similitud, todas las reseñas | 816 | 0.596 | 0.366 | 0.405 | 0.126 | -0.006 | 0.003 |
| promedio + percentiles de similitud, hasta 100 reseñas | 816 | 0.597 | 0.367 | 0.406 | 0.126 | -0.005 | 0.003 |
| percentil 75 por dimensión, hasta 100 reseñas | 768 | 0.598 | 0.376 | 0.407 | 0.130 | -0.005 | 0.007 |
| percentil 50 por dimensión, todas las reseñas | 768 | 0.600 | 0.367 | 0.396 | 0.124 | -0.002 | 0.003 |
| percentil 50 por dimensión, hasta 100 reseñas | 768 | 0.601 | 0.367 | 0.398 | 0.124 | -0.001 | 0.004 |
| promedio, todas las reseñas | 768 | 0.602 | 0.362 | 0.397 | 0.119 | 0.000 | 0.000 |
| percentil 95 por dimensión, todas las reseñas | 768 | 0.602 | 0.333 | 0.389 | 0.131 | 0.000 | 0.010 |
| percentil 95 por dimensión, hasta 100 reseñas | 768 | 0.603 | 0.332 | 0.389 | 0.131 | 0.000 | 0.009 |
| promedio, hasta 100 reseñas | 768 | 0.603 | 0.362 | 0.398 | 0.120 | 0.001 | 0.001 |
| percentil 75 por dimensión, hasta 50 reseñas | 768 | 0.603 | 0.359 | 0.400 | 0.119 | 0.001 | 0.010 |
| percentil 50 por dimensión, hasta 50 reseñas | 768 | 0.605 | 0.353 | 0.396 | 0.112 | 0.002 | 0.014 |
| percentil 90 por dimensión, todas las reseñas | 768 | 0.606 | 0.349 | 0.400 | 0.125 | 0.004 | 0.007 |
| percentil 90 por dimensión, hasta 100 reseñas | 768 | 0.607 | 0.349 | 0.401 | 0.126 | 0.005 | 0.008 |
| promedio + percentiles de similitud, hasta 50 reseñas | 816 | 0.608 | 0.349 | 0.404 | 0.116 | 0.006 | 0.010 |
| promedio, hasta 50 reseñas | 768 | 0.611 | 0.347 | 0.397 | 0.104 | 0.009 | 0.009 |
| percentil 90 por dimensión, hasta 50 reseñas | 768 | 0.616 | 0.334 | 0.390 | 0.128 | 0.014 | 0.010 |
| percentil 95 por dimensión, hasta 50 reseñas | 768 | 0.628 | 0.297 | 0.375 | 0.114 | 0.026 | 0.012 |
