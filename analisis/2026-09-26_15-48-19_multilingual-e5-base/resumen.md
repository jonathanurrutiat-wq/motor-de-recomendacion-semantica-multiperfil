...
Generado el 2026-09-26T15:48:19 con el modelo de embeddings `intfloat/multilingual-e5-base` y pooling `media` para los modelos principales.
...
| Validación cruzada, modelo de reglas en dos etapas | -1.000 | 0.631 | 1.000 | 1.908 | 3.951 | -2.951 |
...
Parámetros: etapa 2 (la regla) 16; etapa 1 0 (regresiones Ridge desde el embedding de 768 dimensiones, una por criterio). Regresión lineal actual: 22.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| promedio, hasta 50 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| promedio, hasta 100 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| promedio, todas las reseñas | 768 | -1.000 | 0.000 | 0.000 | referencia | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 50 por dimensión, hasta 50 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 50 por dimensión, hasta 100 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 50 por dimensión, todas las reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 75 por dimensión, hasta 50 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 75 por dimensión, hasta 100 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 75 por dimensión, todas las reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 90 por dimensión, hasta 50 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 90 por dimensión, hasta 100 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 90 por dimensión, todas las reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 95 por dimensión, hasta 50 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 95 por dimensión, hasta 100 reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| percentil 95 por dimensión, todas las reseñas | 768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| promedio + percentiles de similitud, hasta 50 reseñas | 816 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| promedio + percentiles de similitud, hasta 100 reseñas | 816 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| promedio + percentiles de similitud, todas las reseñas | 816 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
...
| representacion | dimensiones | ρ Spearman | Δ ρ | desv. Δ ρ | mejora ρ | NDCG@10 | Precisión@10 | MAE | Δ MAE | desv. Δ MAE | R² | R² etapa 1 afinidades | R² etapa 1 filtros |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| promedio (sin frases) | 768 | -1.000 | 0.000 | 0.000 | referencia | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| promedio + frases de reseña | 768-778 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| promedio + frases de reseña, ponderadas | 768-778 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| solo frases de reseña | 8-768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| promedio + descripción (control) | 768-770 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
| solo descripción (control) | 2-768 | -1.000 | 0.000 | 0.000 | 0/10 | 0.631 | 1.000 | 1.908 | 0.000 | 0.000 | -2.951 | -3.000 | -3.000 |
...
| excepción · Insoportabilidad Prolongada | 0.083 |
...
|---|---|---|
| the-secret-agent | 10.92 | 7.51 |
| sentimental-value | 10.28 | 7.51 |
| train-dreams | 8.42 | 7.51 |
| sorry-baby | 7.97 | 7.51 |
| it-was-just-an-accident | 7.67 | 7.51 |
| hamnet | 7.39 | 7.51 |
| one-battle-after-another | 7.04 | 7.51 |
| weapons | 5.81 | 7.51 |
