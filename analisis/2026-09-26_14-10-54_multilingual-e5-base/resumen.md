...
Generado el 2026-09-26T14:10:54 con el modelo de embeddings `intfloat/multilingual-e5-base`.
...
|---|---|---|---|---|---|---|---|
| promedio, todas las reseñas | 768 | 0.592 | 0.382 | 0.446 | 0.189 | 0.000 | 0.000 |
| percentil 90 por dimensión, todas las reseñas | 768 | 0.593 | 0.378 | 0.452 | 0.186 | 0.001 | 0.011 |
| promedio, hasta 100 reseñas | 768 | 0.593 | 0.383 | 0.448 | 0.188 | 0.001 | 0.000 |
| percentil 95 por dimensión, todas las reseñas | 768 | 0.593 | 0.366 | 0.439 | 0.190 | 0.001 | 0.010 |
| percentil 90 por dimensión, hasta 100 reseñas | 768 | 0.594 | 0.376 | 0.453 | 0.184 | 0.002 | 0.010 |
| promedio + percentiles de similitud, hasta 100 reseñas | 816 | 0.594 | 0.383 | 0.447 | 0.183 | 0.002 | 0.003 |
| promedio + percentiles de similitud, todas las reseñas | 816 | 0.595 | 0.381 | 0.446 | 0.187 | 0.002 | 0.003 |
| percentil 95 por dimensión, hasta 100 reseñas | 768 | 0.595 | 0.363 | 0.441 | 0.189 | 0.003 | 0.009 |
| percentil 50 por dimensión, todas las reseñas | 768 | 0.597 | 0.376 | 0.441 | 0.183 | 0.004 | 0.004 |
| percentil 50 por dimensión, hasta 100 reseñas | 768 | 0.597 | 0.377 | 0.444 | 0.181 | 0.005 | 0.003 |
| percentil 90 por dimensión, hasta 50 reseñas | 768 | 0.598 | 0.368 | 0.430 | 0.168 | 0.005 | 0.009 |
| promedio + percentiles de similitud, hasta 50 reseñas | 816 | 0.599 | 0.385 | 0.429 | 0.174 | 0.007 | 0.009 |
| promedio, hasta 50 reseñas | 768 | 0.601 | 0.380 | 0.426 | 0.176 | 0.008 | 0.009 |
| percentil 95 por dimensión, hasta 50 reseñas | 768 | 0.605 | 0.351 | 0.413 | 0.182 | 0.012 | 0.014 |
| percentil 50 por dimensión, hasta 50 reseñas | 768 | 0.605 | 0.370 | 0.418 | 0.164 | 0.013 | 0.011 |
| percentil 75 por dimensión, todas las reseñas | 768 | 0.607 | 0.356 | 0.437 | 0.182 | 0.015 | 0.009 |
| percentil 75 por dimensión, hasta 100 reseñas | 768 | 0.608 | 0.357 | 0.439 | 0.180 | 0.015 | 0.010 |
| percentil 75 por dimensión, hasta 50 reseñas | 768 | 0.609 | 0.358 | 0.425 | 0.165 | 0.016 | 0.011 |
