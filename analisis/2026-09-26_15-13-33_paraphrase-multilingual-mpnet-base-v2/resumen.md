...
Generado el 2026-09-26T15:13:33 con el modelo de embeddings `sentence-transformers/paraphrase-multilingual-mpnet-base-v2`.
...
|---|---|---|---|---|---|---|
| Entrenamiento (optimista) | 0.931 | 0.300 | 0.716 | 0.591 | 0.646 | 0.481 |
| Validación cruzada (5 particiones) | 0.906 | 0.200 | 0.598 | 0.891 | 1.589 | -0.276 |
| Validación cruzada con Ridge (comparación) | 0.906 | 0.300 | 0.605 | 0.745 | 1.105 | 0.113 |
| Validación cruzada, modelo de reglas en dos etapas | 0.941 | 0.300 | 0.684 | 0.596 | 0.740 | 0.406 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| percentil 95 por dimensión, todas las reseñas | 768 | 0.944 | 0.006 | 0.009 | 0.400 | 0.629 | 0.602 | 0.000 | 0.010 | 0.333 | 0.389 | 0.131 |
| percentil 95 por dimensión, hasta 100 reseñas | 768 | 0.944 | 0.006 | 0.009 | 0.400 | 0.628 | 0.603 | 0.000 | 0.009 | 0.332 | 0.389 | 0.131 |
| percentil 75 por dimensión, todas las reseñas | 768 | 0.941 | 0.003 | 0.008 | 0.300 | 0.641 | 0.595 | -0.007 | 0.005 | 0.376 | 0.406 | 0.130 |
| percentil 75 por dimensión, hasta 100 reseñas | 768 | 0.940 | 0.002 | 0.008 | 0.300 | 0.641 | 0.598 | -0.005 | 0.007 | 0.376 | 0.407 | 0.130 |
| promedio + percentiles de similitud, todas las reseñas | 816 | 0.939 | 0.002 | 0.006 | 0.340 | 0.643 | 0.596 | -0.006 | 0.003 | 0.366 | 0.405 | 0.126 |
| promedio + percentiles de similitud, hasta 100 reseñas | 816 | 0.939 | 0.001 | 0.006 | 0.340 | 0.643 | 0.597 | -0.005 | 0.003 | 0.367 | 0.406 | 0.126 |
| percentil 90 por dimensión, todas las reseñas | 768 | 0.939 | 0.001 | 0.008 | 0.320 | 0.629 | 0.606 | 0.004 | 0.007 | 0.349 | 0.400 | 0.125 |
| percentil 90 por dimensión, hasta 100 reseñas | 768 | 0.938 | 0.000 | 0.009 | 0.320 | 0.629 | 0.607 | 0.005 | 0.008 | 0.349 | 0.401 | 0.126 |
| promedio, todas las reseñas | 768 | 0.938 | 0.000 | 0.000 | 0.280 | 0.636 | 0.602 | 0.000 | 0.000 | 0.362 | 0.397 | 0.119 |
| promedio, hasta 100 reseñas | 768 | 0.937 | -0.000 | 0.001 | 0.280 | 0.635 | 0.603 | 0.001 | 0.001 | 0.362 | 0.398 | 0.120 |
| percentil 90 por dimensión, hasta 50 reseñas | 768 | 0.937 | -0.001 | 0.009 | 0.380 | 0.626 | 0.616 | 0.014 | 0.010 | 0.334 | 0.390 | 0.128 |
| percentil 50 por dimensión, hasta 100 reseñas | 768 | 0.935 | -0.003 | 0.011 | 0.300 | 0.633 | 0.601 | -0.001 | 0.004 | 0.367 | 0.398 | 0.124 |
| promedio, hasta 50 reseñas | 768 | 0.935 | -0.003 | 0.007 | 0.340 | 0.623 | 0.611 | 0.009 | 0.009 | 0.347 | 0.397 | 0.104 |
| percentil 50 por dimensión, todas las reseñas | 768 | 0.935 | -0.003 | 0.011 | 0.300 | 0.635 | 0.600 | -0.002 | 0.003 | 0.367 | 0.396 | 0.124 |
| percentil 50 por dimensión, hasta 50 reseñas | 768 | 0.934 | -0.004 | 0.008 | 0.300 | 0.623 | 0.605 | 0.002 | 0.014 | 0.353 | 0.396 | 0.112 |
| promedio + percentiles de similitud, hasta 50 reseñas | 816 | 0.932 | -0.006 | 0.010 | 0.300 | 0.630 | 0.608 | 0.006 | 0.010 | 0.349 | 0.404 | 0.116 |
| percentil 95 por dimensión, hasta 50 reseñas | 768 | 0.930 | -0.007 | 0.013 | 0.380 | 0.619 | 0.628 | 0.026 | 0.012 | 0.297 | 0.375 | 0.114 |
| percentil 75 por dimensión, hasta 50 reseñas | 768 | 0.930 | -0.008 | 0.012 | 0.300 | 0.633 | 0.603 | 0.001 | 0.010 | 0.359 | 0.400 | 0.119 |
...
| representacion | dimensiones | NDCG@10 | Δ NDCG@10 | desv. Δ NDCG@10 | Precisión@10 | ρ Spearman | MAE | Δ MAE | desv. Δ MAE | R² | R² etapa 1 afinidades | R² etapa 1 filtros |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| promedio + frases de reseña | 768-778 | 0.938 | 0.000 | 0.000 | 0.280 | 0.638 | 0.600 | -0.003 | 0.002 | 0.368 | 0.397 | 0.133 |
| promedio (sin frases) | 768 | 0.938 | 0.000 | 0.000 | 0.280 | 0.636 | 0.602 | 0.000 | 0.000 | 0.362 | 0.397 | 0.119 |
| promedio + descripción (control) | 768-770 | 0.938 | 0.000 | 0.000 | 0.280 | 0.637 | 0.602 | -0.001 | 0.000 | 0.364 | 0.397 | 0.124 |
| solo descripción (control) | 2-768 | 0.936 | -0.001 | 0.007 | 0.280 | 0.648 | 0.611 | 0.009 | 0.011 | 0.354 | 0.397 | 0.047 |
| promedio + frases de reseña, ponderadas | 768-778 | 0.936 | -0.002 | 0.003 | 0.280 | 0.650 | 0.605 | 0.003 | 0.008 | 0.381 | 0.397 | 0.191 |
| solo frases de reseña | 8-768 | 0.934 | -0.004 | 0.005 | 0.280 | 0.651 | 0.613 | 0.010 | 0.010 | 0.371 | 0.397 | 0.100 |
...
|---|---|---|---|---|---|---|
| camaradería_masculina_rancia | -0.024 | -0.016 | -0.016 | -0.016 | -0.032 | -0.032 |
| insoportabilidad_prolongada | 0.207 | 0.135 | 0.162 | 0.143 | 0.246 | 0.249 |
| control_emocional_artificial | -0.041 | 0.314 | 0.324 | 0.314 | 0.106 | 0.341 |
| personajes_diorama | -0.004 | 0.085 | 0.098 | 0.093 | 0.010 | 0.164 |
| caos_asfixiante | 0.095 | 0.078 | 0.096 | 0.087 | 0.168 | 0.234 |
