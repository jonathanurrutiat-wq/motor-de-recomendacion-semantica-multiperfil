...
Generado el 2026-09-26T13:22:29 con el modelo de embeddings `sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2`.
...
| representacion | dimensiones | MAE | R² | R² etapa 1 afinidades | R² etapa 1 filtros |
|---|---|---|---|---|---|
| promedio + frases de reseña | 384-394 | 0.603 | 0.332 | 0.360 | 0.154 |
| solo descripción (control) | 2-384 | 0.603 | 0.315 | 0.360 | 0.021 |
| promedio + descripción (control) | 384-386 | 0.606 | 0.322 | 0.360 | 0.146 |
| promedio (sin frases) | 384 | 0.608 | 0.318 | 0.360 | 0.142 |
| solo frases de reseña | 8-384 | 0.615 | 0.313 | 0.360 | 0.059 |

R² de la etapa 1 de cada criterio con frases:

| criterio | promedio + frases de reseña | solo descripción (control) | promedio + descripción (control) | promedio (sin frases) | solo frases de reseña |
|---|---|---|---|---|---|
| camaradería_masculina_rancia | -0.025 | -0.029 | -0.025 | -0.025 | -0.031 |
| insoportabilidad_prolongada | 0.183 | 0.122 | 0.146 | 0.141 | 0.205 |
| control_emocional_artificial | 0.351 | -0.006 | 0.350 | 0.345 | 0.148 |
| personajes_diorama | 0.191 | -0.023 | 0.191 | 0.189 | -0.004 |
| caos_asfixiante | 0.071 | 0.042 | 0.066 | 0.057 | -0.024 |
